...
from data_preprocessing import load_and_preprocess_data_angle
...
if __name__ == '__main__':
    ...
    X_train_np, X_test_np, y_train_np, y_test_np = load_and_preprocess_data_angle("./data/多数据源位置预测_all.csv")
    ...
    model = CombinedModel(input_dim=1, hidden_dim=64, output_dim=1, num_blocks=1, num_heads=4).to(device)
